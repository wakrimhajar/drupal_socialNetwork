...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // Display Like entity title.
    $form['like_title'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Like label'),
      '#description' => $this->t('Enter label name for like entity'),
      '#default_value' => $config->get('like_title'),
    ];

    // Display Dislike entity title.
    $form['dislike_title'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Dislike label'),
      '#description' => $this->t('Enter label name for dislike entity'),
